...
const int &Response::getResponseCode() const { return this->_responseCode; }

const size_t &Response::getContentLength() const { return this->_contentLength; }

const std::string &Response::getResponseBody() const { return this->_responseBody; }

const std::string &Response::getResponseHeaders() const { return this->_responseHeaders; }

const std::vector<std::string> &Response::getChunks() const { return this->_chunks; }

const bool &Response::getChunked() const { return this->_chunked; }

const unsigned char	&Response::getCgiFlag()	const { return _cgiFlags; }

void Response::setResponse() { _response = _responseHeaders + ENDH + _responseBody; }

void Response::setResponseCode(int code) { _responseCode = code; }
...
void Response::setResponseBody(const std::string &body) { _responseBody = body; }

void Response::setContentLength(size_t len) { _contentLength = len; }
...
void Response::setLocationRoot(const std::string &locationRoot) { _locationRoot = locationRoot; }

void Response::setLocationRedirection(const std::string& locationRedirection) { _locationRedirection = locationRedirection; }
