...
RequestParser::RequestParser(const RequestParser &other) { *this = other; }
...
const std::string &RequestParser::getRequest() const { return this->_request; }

const std::string &RequestParser::getMethod() const { return this->_method; }

const std::string &RequestParser::getRoute() const { return this->_route; }

const std::string &RequestParser::getQuery() const { return this->_query; }

const std::string &RequestParser::getProtocol() const { return this->_protocol; }

const std::string &RequestParser::getHost() const { return this->_host; }

const std::string &RequestParser::getUserAgent() const { return this->_userAgent; }

const std::string &RequestParser::getAccept() const { return this->_accept; }

const std::string &RequestParser::getAcceptLanguage() const { return this->_acceptLanguage; }

const std::string &RequestParser::getAcceptEncoding() const { return this->_acceptEncoding; }

const std::string &RequestParser::getConnection() const { return this->_connection; }

const std::string &RequestParser::getSecFetchDest() const { return this->_secFetchDest; }

const std::string &RequestParser::getSecFetchMode() const { return this->_secFetchMode; }

const std::string &RequestParser::getSecFetchSite() const { return this->_secFetchSite; }

const std::string &RequestParser::getSecFetchUser() const { return this->_secFetchUser; }

const std::string &RequestParser::getCacheControl() const { return this->_cacheControl; }

const std::string &RequestParser::getBody() const { return this->_body; }

const std::map<std::string, std::string> &RequestParser::getHeaders() const { return this->_headers; }

const size_t &RequestParser::getContentLength() const { return this->_contentLength; }

const std::string &RequestParser::getContentType() const { return this->_contentType; }

const std::string &RequestParser::getPathInfo() const { return this->_pathInfo; }

const std::vector <std::string> &RequestParser::getPath() const { return this->_path; }

const std::vector <std::string> &RequestParser::getSupportedMethods() const { return this->_supportedMethods; }

const std::string &RequestParser::getPathTranslated() const { return this->_pathTranslated; }

const bool &RequestParser::getMultipart() const { return this->_isMiltipart; }

const std::string &RequestParser::getBoundary() const { return this->_boundary; }

void RequestParser::setMethod() { _method = parseByChar(_request, ' '); }
...
void RequestParser::setHost() { _host = parseByHeaderName("Host:"); }

void RequestParser::setUserAgent() { _userAgent = parseByHeaderName("User-Agent:"); }

void RequestParser::setAccept() { _accept = parseByHeaderName("Accept:"); }

void RequestParser::setAcceptLanguage() { _acceptLanguage = parseByHeaderName("Accept-Language:"); }

void RequestParser::setAcceptEncoding() { _acceptEncoding = parseByHeaderName("Accept-Encoding:"); }

void RequestParser::setConnection() { _connection = parseByHeaderName("Connection:"); }

void RequestParser::setSecFetchDest() { _secFetchDest = parseByHeaderName("Sec-Fetch-Dest:"); }

void RequestParser::setSecFetchMode() { _secFetchMode = parseByHeaderName("Sec-Fetch-Mode:"); }

void RequestParser::setSecFetchSite() { _secFetchSite = parseByHeaderName("Sec-Fetch-Site:"); }

void RequestParser::setSecFetchUser() { _secFetchUser = parseByHeaderName("Sec-Fetch-User:"); }

void RequestParser::setCacheControl() { _cacheControl = parseByHeaderName("Cache-Control:"); }
...
void RequestParser::setPathInfo(std::string pathInfo) { _pathInfo = pathInfo; }

void RequestParser::setPathTranslated(std::string pathTranslated) { _pathTranslated = pathTranslated; }
...
const char *RequestParser::UnsupportedMethodException::what() const throw() { return (message_.c_str()); }
